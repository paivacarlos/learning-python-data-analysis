...
#Input data for the level of the game
level = int(input("Qual nível você gostaria de jogar? 1/2/3/4/5 \n"))

#The variable its responsable for the level
length = 500 / level

#Variable that abstract the TK
root = Tk()

#Variable of the title
root.title("Ping Pong")
root.resizable(0, 0)
root.wm_attributes("-topmost", -1)

#Tupla that abstract the parameters of the screen game
